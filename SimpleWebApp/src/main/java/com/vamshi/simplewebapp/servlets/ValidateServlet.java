...
public class ValidateServlet extends HttpServlet {
	...
	protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws IOException,
		...
		PrintWriter out = response.getWriter(); // gets the "out" stream to
												// write html content to output
												// response
		...
		if (flag) {
			...
			RequestDispatcher rd = request.getRequestDispatcher("userpages/userpage.jsp");// ask
